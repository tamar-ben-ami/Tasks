...
Dates that cost money if you miss them, and the garage's phone number.
...
| Date | Km | What was done | Where | Cost |
| --- | --- | --- | --- | --- |
| | | | | |

## Regular checks

Every few months, or before a long drive.
...
- [ ] Wiper blades
- [ ] All lights working
- [ ] Warning triangle and vest actually in the car

## Reference

| Thing | Detail |
| --- | --- |
| Make / model / year | Honda Jazz Hybrid, 2014, automatic (1339cc) |
| Plate | 5057131 |
| Radio code | In the password manager — deliberately not stored here |
| Garage | |
| Tire place | |
| Roadside assistance | |
